...
import sky2 from '../assets/gifs/sky.png';
import mountain2 from '../assets/gifs/mountain.png';
import sky3 from '../assets/gifs/sky.png';
import mountain3 from '../assets/gifs/mountain.png';

const cards = [
  {
    title: 'Left Card',
    layers: [
      { src: sky1, speed: -10, zIndex: 1 },
      { src: mountain1, speed: -20, zIndex: 2 },
    ],
    zoomOnScroll: false,
  },
//   {
